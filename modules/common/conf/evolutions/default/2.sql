...
insert into category (id,name,url,description) values ( 1,'jogos', 'jogos', 'jogos em geral');
insert into category (id,name,url,description) values ( 2,'livros', 'livros', 'ebooks');
insert into category (id,name,url,description) values ( 3,'cosmeticos', 'cosmet', 'cosmeticos importados');
insert into category (id,name,url,description) values ( 4,'roupas', 'roupas', 'roupas importadas');
